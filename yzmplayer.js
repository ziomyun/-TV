...
console.log("\n %c 觅知博客JSON专用弹幕播放器-专业版 %c https://www.98dou.cn/4312.html \n\n", "color: #fadfa3; background: #030307; padding:5px 0;", "background: #fadfa3; padding:5px 0;"),
			console.log('%c页面加载完毕消耗了' + Math.round(performance.now() * 100) / 100 + 'ms',
				...
				console.log('%c觅知博客JSON专用弹幕播放器-专业版：下载地址',
				'background:#fff;color:#FF0000;');
				console.log('%chttps://www.98dou.cn/4312.html',
				'background:#fff;color:#333;text-shadow:0 0 2px #eee,0 0 3px #eee,0 0 3px #eee,0 0 2px #eee,0 0 3px #eee;');
			t.default = a.default
		},
		function(e, t) {},
		...
		function(e, t, n) {
			...
			e.exports = function(e) {
				...
				return t +=
					...
					), t += '\n</div>\n<div class="yzmplayer-menu">\n    ', t += '<div class="yzmplayer-menu-item"> <a href="javascript:void(0);">视频统计信息</a> </div> <div class="yzmplayer-menu-item"> <a href="http://json.zhangze.tv" target="_blank">掌泽智能计费</a> </div>', t +=
				...
				o = function() {
					...
					return a(e, [{
						...
						value: function() {
							...
							this.template.infoVersion.innerHTML = "v10.8-www.98dou.cn", this.template.infoType.innerHTML = this.player.type, this.template
